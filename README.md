# gata OpenAPI Specification
[![Build Status](https://travis-ci.org/aulasoftwarelibre/gata-api-doc.svg?branch=master)](https://travis-ci.org/aulasoftwarelibre/gata-api-doc)
...
6. If you did everything correct, https://aulasoftwarelibre.github.io/gata-api-doc/ will lead to your new docs
...
- Documentation(ReDoc): https://aulasoftwarelibre.github.io/gata-api-doc/
- SwaggerUI: https://aulasoftwarelibre.github.io/gata-api-doc/swagger-ui/
- Look full spec:
    + JSON https://aulasoftwarelibre.github.io/gata-api-doc/swagger.json
    + YAML https://aulasoftwarelibre.github.io/gata-api-doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://aulasoftwarelibre.github.io/gata-api-doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://aulasoftwarelibre.github.io/gata-api-doc/ with url from the message: `Server started <url>`
